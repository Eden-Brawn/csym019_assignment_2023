        ...
        <main>
            ...
            <form action="./sampleReport.png" class="addmore">
                ...
                $course ->execute();
                    ...
                    '<thead><tr><th rowspan="2">Course Name</th><th rowspan="2">UCAS Code</th><th rowspan="2">Level</th><th rowspan="2">Start</th><th rowspan="2">Location</th><th rowspan="2">Description</th><th rowspan="2">Satisfaction</th><th colspan="3">Duration</th><th colspan="3">UK Fees</th><th colspan="2">International Fees</th><th rowspan="2">Work Placement</th><th colspan="3">Entry Requirements</th><th colspan="3">Foundation Requirements</th><th rowspan="2">Language Requirements</th><th rowspan="12">Year 1</th><th rowspan="12">Year 2</th><th rowspan="12">Year 3</th>'.
                    '<tr><td>Full Time</td><td>Part Time</td><td>Foundation</td><td>Full Time</td><td>Part Time</td><td>Foundation</td><td>Full Time</td><td>Foundation</td><td>A Level</td><td>BTEC</td><td>T Level</td><td>A Level</td><td>BTEC</td><td>T Level</td><td>Module 1</td><td>Credits</td><td>Module 2</td><td>Credits</td><td>Module 3</td><td>Credits</td><td>Module 4</td><td>Credits</td><td>Module 5</td><td>Credits</td><td>Module 6</td><td>Credits</td></tr></tr></thead>';
