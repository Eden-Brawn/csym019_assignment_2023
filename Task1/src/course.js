            ...
            const rowPressed = e => { /*The click to show content from https://softauthor.com/get-id-of-clicked-element-in-javascript/#:~:text=The%20buttonPressed()%20callback%20function%20will%20have%20a%20returned%20event,ID%20of%20the%20clicked%20element.*/
                for(let i=0; i < data.courses.length; i++){
                    if(data.courses[i].course == e.target.innerHTML){
                        ...
                        "<h3 id=\"details\">Details</h3><p id=\"details\">" + data.courses[i].description + "</p>" +
                        "<h3 id=\"entry\">Entry Requirements</h3><ul id=\"entry\"><li>At A Level: " + data.courses[i].entryrequirements.standard.alevel + "</li>" +
                        "<li>At BTEC: " + data.courses[i].entryrequirements.standard.btec + "</li>" +
                        "<li>At T Level: " + data.courses[i].entryrequirements.standard.tlevel + "</li></ul><p id=\"entry\">Integrated Foundation Year:</p>" +
                        "<ul id=\"entry\"><li>At A Level: " + data.courses[i].entryrequirements.integratedfoundationyear.alevel + "</li>" +
                        "<li>At BTEC: " + data.courses[i].entryrequirements.integratedfoundationyear.btec + "</li>" +
                        "<li>At T Level: " + data.courses[i].entryrequirements.integratedfoundationyear.tlevel + "</li></ul><p id=\"entry\">Language Requirements:</p>" +
                        "<ul id=\"entry\"><li>International students require an " + data.courses[i].entryrequirements.englishlanguagerequirements + "</li></ul>" +
                        "<h3 id=\"tuition\">Tuition fees</h3><ul id=\"tuition\"><li>The fee for a full time uk student: " + data.courses[i].fees.ukfees.fulltime + "</li>" +
                        ...
                        "<li>The fee for a work placement year: " + data.courses[i].fees.optionalworkplacementyear + "</li></ul>";
                    }
                }
            }
